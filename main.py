...
buttons = [
    [
        InlineKeyboardButton("𝑱𝒐𝒊𝒏 𝑶𝒖𝒓 𝑪𝒉𝒂𝒏𝒏𝒆𝒍", url="https://t.me/Raj_Files"),
    ],
    [
        InlineKeyboardButton("𝑱𝒐𝒊𝒏 𝑶𝒖𝒓 𝑺𝒆𝒄𝒐𝒏𝒅 𝑪𝒉𝒂𝒏𝒏𝒆𝒍", url="https://t.me/BotsHubs")
    ]
]
...
def echo(client: pyrogram.client.Client, message: pyrogram.types.messages_and_media.message.Message):
    ...
    if not checkuser(message):
        app.send_message(message.chat.id, '__You are either not **Authorized** or **Banned**__', reply_to_message_id=message.id,reply_markup=reply_markups)
        return
